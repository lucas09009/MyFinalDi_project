...
Revision ID: 17e7644b025f
Revises: 5e8641fb8dee
Create Date: 2023-12-18 18:02:49.483103
...
revision = '17e7644b025f'
down_revision = '5e8641fb8dee'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('Image', sa.String(), nullable=True),
    sa.Column('Biographie', sa.NullType(), nullable=True),
    ...
    sa.Column('details', sa.NullType(), nullable=False),
